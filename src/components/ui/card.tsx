  ...
  "rounded-xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card border-border shadow-lg shadow-black/10",
        interactive: "bg-card border-border hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 cursor-pointer",
        gradient: "bg-gradient-to-b from-card to-card/50 border-border",
